<template>
  <div class="flex flex-row justify-between items-center bg-[#fff] rounded-2xl p-3">
    <span class="text-xl font-semibold uppercase">Daniele Dettori</span>
    <button
      class="flex flex-row items-center bg-[#EFF6FE] rounded-full text-[#2573D0] font-semibold gap-2 px-4 py-2"><svg
        ...
        <path
          ...
          stroke="#2573D0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
      </svg>
    </button>
  </div>
</template>